    ...
    return (
        <NextLink {...props}>
            <a className={[
                'transition',
                isActive
                    ? 'font-semibold text-accent-500 dark:text-accent-400 hover:opacity-70 dark:hover:opacity-80'
...
const styles = {
    variants: {
        default: 'text-gray-600 dark:text-gray-400 hover:text-accent-500 dark:hover:text-accent-400',
