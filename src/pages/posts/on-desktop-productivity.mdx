...
> **Note**
> As of Keyboard Maestro v10.0 this concept of helper macros has been completely replaced by subroutines. Functionally it's the same, but having it as a first-class citizen offers improvements in terms of clarity and usability.
