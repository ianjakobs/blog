...
> **Note**
> For custom icons you can download Apple's [SF Symbols](https://developer.apple.com/sf-symbols/) for free, which is the same set of icons that have just been added to Keyboard Maestro itself.
